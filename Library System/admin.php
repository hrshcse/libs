						...
						<table id = "table" class = "table table-bordered">
							...
							?>	
								<tr class = "target">
									...
									<td><a id="id2" href = "#" class = "btn btn-danger deladmin_id" value = "<?php echo $f_admin['admin_id']?>"><span class = "glyphicon glyphicon-remove"></span> Delete</a> <a id="id2" href = "#" class = "btn btn-warning eadmin_id" value = "<?php echo $f_admin['admin_id']?>"><span class = "glyphicon glyphicon-edit"></span> Edit</a></td>
								</tr>
							<?php
								}
							?>	
